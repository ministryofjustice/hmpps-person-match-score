...
def test_names_1(spark_session):
    names_list = [
    ...
    df_expected = [
        {'id': 1, 'surname_std': 'jones', 'forename1_std': 'john', 'forename2_std': 'paul', 'forename3_std': 'smith',
         'forename4_std': None, 'forename5_std': None},
        {'id': 2, 'surname_std': 'jones', 'forename1_std': 'john', 'forename2_std': 'smith', 'forename3_std': None,
         'forename4_std': None, 'forename5_std': None},
        {'id': 3, 'surname_std': 'jones', 'forename1_std': 'john', 'forename2_std': 'smith', 'forename3_std': None,
         'forename4_std': None, 'forename5_std': None}
    ]
